// Inline SVG icon system — zero dependencies, offline-safe, themeable.
// A hidden <svg> sprite of <symbol>s is injected once; icon(name) returns a
// <svg><use href="#i-name"></svg> that inherits the current text colour (so
// icons follow light/dark and .active states for free). Replaces emoji, which
// render inconsistently across the Android WebView and desktop.
(function () {
  // Feather/Lucide (MIT) 24x24 stroke paths. Keep names semantic, not visual,
  // so a swap here restyles every call site at once.
  const P = {
    home: '<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M9 22V12h6v10"/>',
    sales: '<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1z"/><path d="M8 7h8M8 11h8M8 15h5"/>',
    plus: '<path d="M12 5v14M5 12h14"/>',
    expenses: '<polyline points="23 18 13.5 8.5 8.5 13.5 1 6"/><polyline points="17 18 23 18 23 12"/>',
    insights: '<path d="M12 2a6 6 0 0 0-4 10.5c.5.5.8 1.2.8 2V15h6.4v-.5c0-.8.3-1.5.8-2A6 6 0 0 0 12 2z"/><line x1="9" y1="18" x2="15" y2="18"/><line x1="10" y1="21" x2="14" y2="21"/>',
    products: '<path d="M12 2 3 7v10l9 5 9-5V7z"/><path d="M3 7l9 5 9-5"/><path d="M12 12v10"/>',
    ...
    admin: '<line x1="12" y1="20" x2="12" y2="10"/><line x1="18" y1="20" x2="18" y2="4"/><line x1="6" y1="20" x2="6" y2="16"/>',
    ...
    party: '<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/>',
  ...
  // icon("home") -> "<svg class='ic' ...><use href='#i-home'/></svg>".
  // Unknown names throw in the console but render an empty box, never crash.
